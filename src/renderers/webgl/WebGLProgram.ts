namespace THREE
{
	...
	{
		diagnostics: { runnable: boolean; material: any; programLog: any; vertexShader: { log: any; prefix: any; }; fragmentShader: { log: any; prefix: any; }; };
		getUniforms: () => any;
		getAttributes: () => any;
		destroy: () => void;
		name: any;
		...
		constructor(renderer, extensions, cacheKey, material, shader, parameters)
		{
